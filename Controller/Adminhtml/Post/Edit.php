...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Test_Testimonials::post')
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Testimonials Post') : __('New Testimonials Post'),
            $id ? __('Edit Testimonials Post') : __('New Testimonials Post')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Testimonials Posts'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('Testimonials'));
