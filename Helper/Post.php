...
namespace Test\Testimonials\Helper;
...
class Post extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    /**
     * @var \Test\Testimonials\Model\Post
     */
    protected $_post;
    ...
    \Magento\Framework\App\Helper\Context $context, \Test\Testimonials\Model\Post $post, \Magento\Framework\View\Result\PageFactory $resultPageFactory
    ) {    
        $this->_post = $post;
    ...
    public function prepareResultPost(Action $action, $postId = null) {
        ...
        // This will generate a layout handle like: testimonials_post_view_id_1
        // giving us a unique handle to target specific testimonials posts if we wish to.
        ...
        $this->_eventManager->dispatch(
                'test_testimonials_post_render', ['post' => $this->_post, 'controller_action' => $action]
        );
